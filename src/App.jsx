  ...
  return (
    <>
      <div className='w-[100vw] h-[100vh] flex flex-col relative'>
        <div className='w-full h-[10vh] border border-purple-500 bg-white rounded-2xl flex justify-between items-center px-3 absolute top-0 z-10'>
          ...
          <div className='flex items-center gap-x-8'>
            ...
            <Link className='hover:text-purple-500 transition-all ease-in-out'>Support</Link>
