...
const Feature = () => {
  ...
  return (
    <>
    <div className='w-[100vw] h-[80vh] flex justify-center items-center feature-bg'>
      <h1 className='text-5xl text-purple-400 font-bold'>Features</h1>
    </div>
    <div className='w-[100vw] h-[fit] flex justify-between mt-20 px-8' id='subject-preferred-courses'>
      <div className='w-[40%] flex flex-col'>
        <h1 className='text-3xl font-bold'>Subject Preferred Courses</h1>
        <p className='text-lg font-extralight'>At the very core of our platform lies an unwavering commitment to connecting students with precisely the expertise they seek. We are meticulously building a highly granular and intuitive subject catalog, extending beyond broad categories to encompass niche subtopics and specific skill levels. Our dedication is evident in the robust search and filtering mechanisms we are implementing, empowering students to pinpoint the ideal tutor based on their exact academic needs, whether it's mastering advanced calculus concepts or preparing for a specific board examination. We believe that targeted matching is paramount to effective learning, and our efforts in this area reflect our determination to facilitate meaningful educational connections.</p>
      </div>
      <div className='w-[40%] subject-preferred-courses'></div>
    </div>
    <div className='w-[100vw] h-[fit] flex flex-row-reverse justify-between mt-20 px-8' id='engage-learners'>
      <div className='flex flex-col items-end w-[40%]'>
        <h1 className='text-3xl font-bold'>Engage Learners</h1>
      ...
      <div className='engage-learner w-[40%]'></div>
    </div>
    <div className='w-[100vw] h-[fit] flex justify-between mt-20 px-8' id='global-reach'>
      <div className='w-[40%] flex flex-col'>
        <h1 className='text-3xl font-bold'>Global Reach</h1>
        <p className='text-lg font-extralight'>Our vision extends far beyond geographical limitations. We are determined to create a truly global learning community, connecting students with exceptional tutors from around the world. By thoughtfully addressing the complexities of time zones and striving for multi-lingual accessibility, we are breaking down barriers to quality education. Our dedication to global reach is driven by the belief that talent and the desire to learn know no borders, and we are committed to building a platform that reflects this interconnected reality.</p>
      </div>
      <div className='global-reach w-[40%]'></div>
    </div>
    <div className='w-[100vw] h-[fit] flex flex-row-reverse justify-between my-20 px-8 border-b border-black pb-8' id='flexible-pricing'>
      <div className='w-[40%] flex flex-col items-end'>
        <h1 className='text-3xl font-bold'>Flexible Pricing</h1>
      ...
      <div className='w-[40%] flexible-pricing'></div>
    </div>
    <Footer />
    </>
  )
